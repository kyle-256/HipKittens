...
- **Reviewer** IN-FLIGHT — defer to next conversation.

### R44 NEW methodology rules (potential, pending Reviewer)
...
- (pending) Reviewer — 14th-cycle baseline + RECONFIRM + gold-standard + methodology
