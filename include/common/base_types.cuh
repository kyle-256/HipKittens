...
/**
 * @brief Packed pair of FP4 E2M1 values used by ROCm OCP helpers.
 */
using fp4e2m1_2 = __hipext_ocp_fp4x2_e2m1;
/**
 * @brief Packed word of eight FP4 E2M1 values.
 */
using fp4e2m1_8 = __amd_fp4x8_storage_t;
