 ...
 */
 ...
 struct art_base {
    ...
    static_assert(
        std::is_same_v<dtype, bf16_2> ||
        std::is_same_v<dtype, float2> ||
        std::is_same_v<dtype, half_2> ||
        std::is_same_v<dtype, __hip_fp8x4_e4m3> ||
        std::is_same_v<dtype, __hip_fp8x4_e4m3_fnuz> ||
        std::is_same_v<dtype, __hip_fp8x4_e5m2> ||
        std::is_same_v<dtype, __hip_fp8x4_e5m2_fnuz> ||
        std::is_same_v<dtype, fp8e8m0_4>,
