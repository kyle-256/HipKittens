#!/usr/bin/env python3
"""R59 Opt V-1 — 96x640 alt-tile probe on L1 (4096, 32768, 14336).

R59 J-3 / V-1: 96x640 aiter alt-tile via R50D shim AS-IS
(current AITER 256x256 R57J1 99.94% under ITERS=500).
Hypothesis: low (eff=83.5). PROMOTE only if SMOKE > 100.94% (current + 1.0pp).
...
def main():
    ...
    ap.add_argument("--tag", default="R59_OPT_V1")
    ...
    results = []
    log_lines = []
    log_lines.append(f"R59 Opt V-1 bench - mode={args.mode}, gpu={gpu_list}, "
