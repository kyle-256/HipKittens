#!/usr/bin/env python3
"""R56 Opt G-3 / L2 — 128x512 falsification probe on (32768, 4096, 14336).
...
Per-shape grid (bdx=256, gdz=1):
  ...
  gdy = ceil(M/128) = ceil(32768/128)  = 256
"""
import argparse
...
COMPETITOR_TFLOPS = 5223.4  # L2 baseline from bench_all_42.py
...
def main():
    ...
    ap.add_argument("--tag", default="R56_OPT_G3_L2")
