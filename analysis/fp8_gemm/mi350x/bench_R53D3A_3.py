#!/usr/bin/env python3
"""R53 Opt D-3A_3 — bench harness for the aiter `.co` dlopen shim on (4096, 6144, 32768).
...
WCF_GATE = 0.02
FINITE_GATE = 0.97
M, N, K = 4096, 6144, 32768
COMPETITOR_TFLOPS = 3784.2  # from bench_all_42.py for (4096, 6144, 32768)

VARIANT_TAG = "R53_OPT_D3A_3"
