#!/usr/bin/env python3
"""R58 Opt P-1 — 128x256 alt-tile probe on HK cell (16384, 4096, 2048).

R58 I-3 / P-1: 128x256 aiter alt-tile via R50D shim AS-IS (HK baseline 109.57% R57).
Hypothesis: low (eff=85.3 vs HK 256x256). PROMOTE only if SMOKE > 110.57% (HK + 1.0pp).
...
def main():
    ...
    ap.add_argument("--tag", default="R58_OPT_P1")
    ...
    results = []
    log_lines = []
    log_lines.append(f"R58 Opt P-1 bench - mode={args.mode}, gpu={gpu_list}, "
