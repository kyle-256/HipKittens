...
mod_square = load('tk_mxfp8_r34c_square', so_square)
mod_rect = load('tk_mxfp8_r34c_path2', so_rect)
...
print(f'CORRECTNESS_RECT_PATH2 snr_db={snr_rt:.2f} pass_rate_pct={pass_rt:.2f}')
...
for _ in range(2):
    ...
    if not torch.equal(C_rt[:M, :N], C_rt0[:M, :N]):
        det_ok = False; break
print(f'DETERMINISM_RECT_PATH2 ok={det_ok}')
