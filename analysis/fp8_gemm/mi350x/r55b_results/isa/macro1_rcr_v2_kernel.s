...
.LBB2_6:
	...
	v_or_b32_e32 v173, 0xa000, v151
	buffer_load_dwordx4 v156, s[16:19], 0 offen lds
	s_addc_u32 s9, s9, 0
	s_mov_b32 m0, s2
	v_readfirstlane_b32 s2, v173
	v_or_b32_e32 v175, 0xc000, v153
	buffer_load_dwordx4 v152, s[8:11], 0 offen lds
	s_mov_b32 m0, s2
	s_add_u32 s16, s24, 0x80
	v_readfirstlane_b32 s2, v175
	v_or_b32_e32 v176, 0xe000, v153
	buffer_load_dwordx4 v150, s[8:11], 0 offen lds
	s_addc_u32 s17, s25, 0
	s_mov_b32 m0, s2
	v_readfirstlane_b32 s2, v176
	buffer_load_dwordx4 v154, s[16:19], 0 offen lds
	s_mov_b32 m0, s2
	...
	v_lshl_or_b32 v166, v2, 8, v3
	v_lshlrev_b32_e32 v3, 3, v210
	v_lshl_or_b32 v167, v2, 7, v3
	...
	v_bitop3_b32 v168, v5, v4, s36 bitop3:0x6c
	...
	v_bitop3_b32 v171, v5, v2, s36 bitop3:0x6c
