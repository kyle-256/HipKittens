#!/bin/bash
# R38 Dev C Task 2: 4-GPU triangulation of R36 Dev B 6th V2-RRR autotune predicate
...
echo "===== R38 Dev C 8B-Down 4-GPU triangulation cell=$CELL M=$M N=$N K=$K phys_gpu=$PHYS_GPU =====" | tee "$OUT"
