#!/bin/bash
# R36 Reviewer Phase 1: 4-GPU triangulation for 70B KV V2-CRR (M=4096 N=1024 K=8192)
# Goal: 6th cross-cycle data point for stochastic per-(GPU x cycle) high-regime hypothesis.
#       R31 GPU0 high (786.38), R32 GPU5 high (786.59), R33 NONE (768 cluster),
#       R34 GPU6 high (787.13), R35 GPU6 high (789.28) -- first 2-cycle repeat,
#       R36 ???
#
...
OUTDIR="$HERE/r36_reviewer_4gpu_runs"
mkdir -p "$OUTDIR"
