...
print(f"=== MXFP4 Hybrid Kernel: M={M}, N={N}, K={K} ===")
...
run = lambda: tk_mxfp4_hybrid.gemm_rcr(A, B, A_scale, B_scale, C)
...
outfile = os.environ.get("MXFP4_OUTPUT",
    f"mxfp4_hybrid_results_{M}x{N}x{K}{suffix}.json")
