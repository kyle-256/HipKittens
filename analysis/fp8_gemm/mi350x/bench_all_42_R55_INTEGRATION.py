#!/usr/bin/env python3
"""R55 INTEGRATION reviewer bench — 10-run @ 80% INDEPENDENT-seed gate.

Fork of bench_all_42_R54_INTEGRATION.py with these changes:
...
AITER_SHAPES = {
    ...
    # R53 64x1024 cells (D-3B)
    (4096, 32768, 14336):  (64,  1024, AITER_CO_64x1024, AITER_KNAME_64x1024, "R53D3B_1"),
    (32768, 4096, 14336):  (64,  1024, AITER_CO_64x1024, AITER_KNAME_64x1024, "R53D3B_2"),
    (128256, 32768, 4096): (64,  1024, AITER_CO_64x1024, AITER_KNAME_64x1024, "R53D3B_3"),
    # R53 64x1024 cells (D-3C)
    (14336, 32768, 4096):  (64,  1024, AITER_CO_64x1024, AITER_KNAME_64x1024, "R53D3C_1"),
    (28672, 32768, 4096):  (64,  1024, AITER_CO_64x1024, AITER_KNAME_64x1024, "R53D3C_2"),
    (16384, 4096, 14336):  (64,  1024, AITER_CO_64x1024, AITER_KNAME_64x1024, "R53D3C_3"),
...
def run_one_pass(gpus, run_label, jobs, seed):
    print(f"R55 INTEG Bench [{run_label}] seed={seed} - GPUs: {gpus}, n_jobs={len(jobs)}")
    print("=" * 110)
...
def main():
    ...
    ap.add_argument("--manifest", default="R55_INTEGRATION_MANIFEST.json")
    ap.add_argument("--out", default="R55_INTEGRATION_10RUN.json")
    ap.add_argument("--log", default="R55_INTEGRATION_10RUN.log")
    ...
    log(f"R55 INTEGRATION bench: {len(jobs)} shapes, runs={args.runs}, GPUs={gpus}")
