#!/usr/bin/env python3
"""R53 Opt D-3A_2 — bench harness for the aiter `.co` dlopen shim on (6144, 4096, 16384).
...
WCF_GATE = 0.02
FINITE_GATE = 0.97
M, N, K = 6144, 4096, 16384
COMPETITOR_TFLOPS = 4428.1  # from bench_all_42.py for (6144, 4096, 16384)

VARIANT_TAG = "R53_OPT_D3A_2"
