"""R33 Reviewer: Single-process preheat + 5x bench for ONE kind (fp8 or mxfp8)
on ONE shape and ONE layout. Identical to r32_reviewer_bench5x.py (no
methodology change this cycle — R31 sclk-fix carried forward).
