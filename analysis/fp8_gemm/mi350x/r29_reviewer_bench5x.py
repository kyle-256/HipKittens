"""R29 Reviewer: Single-process preheat + 5x bench for ONE kind (fp8 or mxfp8)
on ONE shape and ONE layout. Mirrors r28a_bench5x.py methodology.

Usage: HIP_VISIBLE_DEVICES=N python3 r29_reviewer_bench5x.py <kind> <layout> M N K
  kind   = fp8 | mxfp8
  layout = rcr | rrr | crr
