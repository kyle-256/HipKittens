...
.LBB0_6:
	...
	s_load_dwordx2 s[20:21], s[0:1], 0xb0
	s_waitcnt lgkmcnt(0)
	s_lshr_b32 s3, s8, 25
	s_add_i32 s6, s6, s3
	s_ashr_i32 s3, s6, 7
	...
	s_sub_i32 s25, s11, s6
	s_add_i32 s25, s25, s9
	v_and_b32_e32 v84, 48, v0
	s_and_b32 s6, s8, 0xfffffe00
	s_sub_i32 s6, s7, s6
	s_xor_b32 s3, s6, s3
	...
	v_bitop3_b32 v4, v1, s36, v0 bitop3:0x48
	...
	s_add_i32 s7, s6, 1
	s_cmp_ge_u32 s3, s10
	s_cselect_b32 s19, s7, s6
	v_mad_u64_u32 v[66:67], s[6:7], v5, s12, v[4:5]
	s_mov_b32 s6, -1
	v_lshlrev_b32_e32 v83, 13, v8
	s_mov_b32 s7, 0x110000
	s_lshl_b32 s3, s25, 8
	v_or_b32_e32 v2, s3, v1
	v_ashrrev_i32_e32 v6, 6, v2
	v_mov_b64_e32 v[2:3], s[4:5]
	v_mad_i64_i32 v[6:7], s[4:5], s2, v6, v[2:3]
	s_nop 0
	v_readfirstlane_b32 s4, v6
	v_or_b32_e32 v6, 0x60, v5
	s_add_i32 s45, s33, 0x1000
	s_mov_b32 s15, s45
	v_readfirstlane_b32 s5, v7
	s_mov_b64 s[10:11], s[6:7]
	s_mov_b64 s[8:9], s[4:5]
	s_mov_b32 s8, s30
	s_add_i32 s46, s33, 0x2000
	s_mov_b32 s9, s31
	s_mul_i32 s31, s12, s3
	s_mov_b32 s21, s31
	;;#ASMSTART
	;;#ASMEND
	;;#ASMSTART
	...
	v_add_u32_e32 v67, s14, v66
	v_add_u32_e32 v94, s14, v67
	s_mov_b32 s14, s46
	s_add_i32 s47, s33, 0x3000
	buffer_load_dwordx4 v66, s[8:11], s21 offen lds
	;;#ASMSTART
	;;#ASMEND
	s_mov_b32 m0, s15
	s_bitset1_b32 s3, 7
	s_mul_i32 s48, s12, s3
	v_lshlrev_b32_e32 v82, 3, v0
	buffer_load_dwordx4 v67, s[8:11], s21 offen lds
	;;#ASMSTART
	;;#ASMEND
	s_mov_b32 m0, s14
	v_mad_u64_u32 v[68:69], s[14:15], v6, s12, v[4:5]
	s_mov_b32 s14, s47
	s_add_i32 s49, s39, 0x1000
	s_mov_b32 s12, s48
	buffer_load_dwordx4 v94, s[8:11], s21 offen lds
	;;#ASMSTART
	;;#ASMEND
	s_mov_b32 m0, s14
	s_mov_b32 s14, s39
	s_add_i32 s50, s39, 0x2000
	buffer_load_dwordx4 v68, s[8:11], s21 offen lds
	;;#ASMSTART
	;;#ASMEND
	;;#ASMSTART
	;;#ASMEND
	s_mov_b32 m0, s14
	s_mov_b32 s14, s49
	s_add_i32 s51, s39, 0x3000
	buffer_load_dwordx4 v66, s[8:11], s12 offen lds
	;;#ASMSTART
	;;#ASMEND
	s_mov_b32 m0, s14
	s_mov_b32 s14, s50
	s_add_i32 s52, s41, 0x1000
	s_mov_b32 s23, s52
	buffer_load_dwordx4 v67, s[8:11], s12 offen lds
	;;#ASMSTART
	;;#ASMEND
	s_mov_b32 m0, s14
	s_mov_b32 s14, s51
	s_add_i32 s53, s41, 0x2000
	buffer_load_dwordx4 v94, s[8:11], s12 offen lds
	;;#ASMSTART
	;;#ASMEND
	s_mov_b32 m0, s14
	s_add_i32 s54, s41, 0x3000
	buffer_load_dwordx4 v68, s[8:11], s12 offen lds
	s_xor_b32 s12, s19, s13
	s_sub_i32 s14, s12, s13
	s_lshl_b32 s19, s14, 8
	s_add_i32 s56, s43, 0x1000
	v_mad_u64_u32 v[70:71], s[12:13], v5, s18, v[4:5]
	...
	v_add_u32_e32 v69, s22, v70
	v_add_u32_e32 v71, s22, v69
	s_mov_b32 s22, s53
	s_add_i32 s59, s33, 0x5000
	buffer_load_dwordx4 v70, s[12:15], s21 offen lds
	;;#ASMSTART
	;;#ASMEND
	s_mov_b32 m0, s23
	s_add_i32 s60, s33, 0x6000
	buffer_load_dwordx4 v69, s[12:15], s21 offen lds
	;;#ASMSTART
	;;#ASMEND
	s_mov_b32 m0, s22
	v_mad_u64_u32 v[72:73], s[22:23], v6, s18, v[4:5]
	s_add_u32 s73, s30, s48
	s_add_u32 s74, s34, s35
	v_and_b32_e32 v73, 0x1f8, v82
	;;#ASMSTART
	buffer_load_dwordx2 v[80:81], v73, s[4:7], s37 offen
	;;#ASMEND
	s_add_i32 s61, s33, 0x7000
	v_or_b32_e32 v4, s3, v1
	v_ashrrev_i32_e32 v4, 6, v4
	v_bfe_u32 v6, v0, 6, 1
	v_lshlrev_b32_e32 v86, 13, v6
	v_or_b32_e32 v87, 0x10000, v86
	s_mov_b32 s22, s54
	v_lshlrev_b32_e32 v7, 6, v6
	v_or_b32_e32 v182, s19, v7
	buffer_load_dwordx4 v71, s[12:15], s21 offen lds
	;;#ASMSTART
	;;#ASMEND
	s_mov_b32 m0, s22
	s_mov_b32 s22, s43
	s_add_i32 s62, s39, 0x5000
	buffer_load_dwordx4 v72, s[12:15], s21 offen lds
	s_or_b32 s21, s19, 0x80
	s_mul_i32 s55, s18, s21
	s_add_u32 s75, s34, s55
	s_add_u32 s73, s73, 0x100
	s_add_i32 s63, s39, 0x6000
	s_mov_b32 s18, s55
	;;#ASMSTART
	;;#ASMEND
	;;#ASMSTART
	...
	s_mov_b32 m0, s22
	s_mov_b32 s22, s56
	s_add_i32 s64, s39, 0x7000
	buffer_load_dwordx4 v70, s[12:15], s18 offen lds
	;;#ASMSTART
	;;#ASMEND
	s_mov_b32 m0, s22
	s_mov_b32 s22, s57
	s_add_i32 s65, s41, 0x5000
	buffer_load_dwordx4 v69, s[12:15], s18 offen lds
	;;#ASMSTART
	;;#ASMEND
	s_mov_b32 m0, s22
	s_mov_b32 s22, s58
	s_add_i32 s66, s41, 0x6000
	buffer_load_dwordx4 v71, s[12:15], s18 offen lds
	;;#ASMSTART
	;;#ASMEND
	s_mov_b32 m0, s22
	s_mov_b32 s22, s38
	s_add_i32 s67, s41, 0x7000
	buffer_load_dwordx4 v72, s[12:15], s18 offen lds
	s_or_b32 s18, s31, 0x80
	;;#ASMSTART
	;;#ASMEND
	;;#ASMSTART
	;;#ASMEND
	s_mov_b32 m0, s22
	s_mov_b32 s22, s59
	s_add_i32 s68, s43, 0x5000
	buffer_load_dwordx4 v66, s[8:11], s18 offen lds
	;;#ASMSTART
	;;#ASMEND
	s_mov_b32 m0, s22
	s_mov_b32 s22, s60
	s_add_i32 s69, s43, 0x6000
	buffer_load_dwordx4 v67, s[8:11], s18 offen lds
	;;#ASMSTART
	;;#ASMEND
	s_mov_b32 m0, s22
	s_mov_b32 s22, s61
	s_add_i32 s70, s43, 0x7000
	buffer_load_dwordx4 v94, s[8:11], s18 offen lds
	;;#ASMSTART
	;;#ASMEND
	s_mov_b32 m0, s22
	s_mov_b32 s22, s40
	s_add_u32 s74, s74, 0x100
	buffer_load_dwordx4 v68, s[8:11], s18 offen lds
	...
	v_mad_i64_i32 v[2:3], s[0:1], s2, v4, v[2:3]
	s_nop 0
	...
	v_mad_i64_i32 v[4:5], s[16:17], s20, v4, v[2:3]
	s_nop 0
	v_readfirstlane_b32 s22, v4
	v_or_b32_e32 v4, s21, v7
	v_ashrrev_i32_e32 v4, 6, v4
	v_mad_i64_i32 v[2:3], s[20:21], s20, v4, v[2:3]
	s_nop 0
	...
	v_bitop3_b32 v14, v82, v18, s36 bitop3:0x6c
	v_or_b32_e32 v18, 64, v18
	v_bitop3_b32 v30, v82, v18, s36 bitop3:0x6c
	...
	v_bitop3_b32 v95, v82, v88, s36 bitop3:0x6c
	v_or_b32_e32 v88, 64, v84
	v_or_b32_e32 v89, v83, v88
	v_bitop3_b32 v96, v82, v89, s36 bitop3:0x6c
	v_or_b32_e32 v89, 0x4000, v83
	v_or_b32_e32 v90, v89, v84
	v_bitop3_b32 v97, v82, v90, s36 bitop3:0x6c
	v_lshrrev_b32_e32 v34, 4, v50
	v_bitop3_b32 v46, v34, v50, s36 bitop3:0x6c
	;;#ASMSTART
	...
	v_bitop3_b32 v98, v82, v89, s36 bitop3:0x6c
	v_add_u32_e32 v89, v87, v84
	v_lshrrev_b32_e32 v90, 4, v89
	v_bitop3_b32 v99, v90, v89, s36 bitop3:0x6c
	v_add_u32_e32 v50, 64, v50
	v_lshrrev_b32_e32 v51, 4, v50
	v_bitop3_b32 v62, v51, v50, s36 bitop3:0x6c
	;;#ASMSTART
	...
	;;#ASMSTART
	buffer_load_dwordx2 v[74:75], v73, s[0:3], s37 offen
	;;#ASMEND
	v_add_u32_e32 v87, v87, v88
	v_lshrrev_b32_e32 v89, 4, v87
	v_bitop3_b32 v100, v89, v87, s36 bitop3:0x6c
	v_or_b32_e32 v85, v86, v85
	v_or_b32_e32 v86, 0x14000, v85
	v_or_b32_e32 v87, v86, v84
	v_bitop3_b32 v101, v82, v87, s36 bitop3:0x6c
	s_mov_b64 s[18:19], s[6:7]
	s_mov_b64 s[16:17], s[4:5]
	s_mov_b32 s16, s22
	v_or_b32_e32 v86, v86, v88
	v_bitop3_b32 v102, v82, v86, s36 bitop3:0x6c
	v_or_b32_e32 v86, 0x18000, v85
	v_or_b32_e32 v87, v86, v84
	v_bitop3_b32 v103, v82, v87, s36 bitop3:0x6c
	s_mov_b32 s17, s23
	;;#ASMSTART
	buffer_load_dwordx2 v[78:79], v73, s[16:19], s37 offen
	;;#ASMEND
	v_or_b32_e32 v86, v86, v88
	v_bitop3_b32 v104, v82, v86, s36 bitop3:0x6c
	...
	v_bitop3_b32 v105, v82, v86, s36 bitop3:0x6c
	s_mov_b32 s21, s72
	;;#ASMSTART
	buffer_load_dwordx2 v[76:77], v73, s[20:23], s37 offen
	;;#ASMEND
	v_or_b32_e32 v85, v85, v88
	v_bitop3_b32 v106, v82, v85, s36 bitop3:0x6c
	v_or_b32_e32 v85, 0x8000, v83
	v_or_b32_e32 v86, v85, v84
	v_bitop3_b32 v107, v82, v86, s36 bitop3:0x6c
	s_add_u32 s72, s30, s31
	s_add_u32 s72, s72, 0x100
	v_or_b32_e32 v85, v85, v88
	v_bitop3_b32 v108, v82, v85, s36 bitop3:0x6c
	v_or_b32_e32 v83, 0xc000, v83
	v_or_b32_e32 v84, v83, v84
	v_bitop3_b32 v109, v82, v84, s36 bitop3:0x6c
	v_or_b32_e32 v83, v83, v88
	v_bitop3_b32 v110, v82, v83, s36 bitop3:0x6c
	s_mov_b64 s[36:37], 0
...
ds_read_b128 v[30:33], v98 offset:6144
	...
	;;#ASMEND
	buffer_load_dwordx4 v66, s[8:11], s80 offen lds
	s_mov_b32 m0, s45
	s_add_u32 s81, s77, 0x100
	buffer_load_dwordx4 v67, s[8:11], s80 offen lds
	s_mov_b32 m0, s46
	;;#ASMSTART
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[156:159],  v[128:131], v[62:65], a[156:159],  v74, v79 op_sel:[1,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	;;#ASMEND
	s_add_u32 s78, s35, s36
	buffer_load_dwordx4 v94, s[8:11], s80 offen lds
	s_mov_b32 m0, s47
	s_add_u32 s82, s78, 0x100
	buffer_load_dwordx4 v68, s[8:11], s80 offen lds
	s_mov_b32 m0, s39
	;;#ASMSTART
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[172:175], v[132:135], v[62:65], a[172:175], v75, v79 op_sel:[0,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	buffer_load_dwordx4 v66, s[8:11], s81 offen lds
	s_mov_b32 m0, s49
	s_add_u32 s83, s79, 0x100
	buffer_load_dwordx4 v67, s[8:11], s81 offen lds
	s_mov_b32 m0, s50
	;;#ASMSTART
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[188:191], v[136:139], v[62:65], a[188:191], v75, v79 op_sel:[1,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	;;#ASMEND
	s_add_i32 s84, s71, 0xfffff200
	buffer_load_dwordx4 v94, s[8:11], s81 offen lds
	s_mov_b32 m0, s51
	;;#ASMSTART
	buffer_load_dwordx2 v[88:89], v73, s[4:7], s84 offen
	;;#ASMEND
	;;#ASMSTART
	buffer_load_dwordx2 v[82:83], v73, s[0:3], s84 offen
	;;#ASMEND
	;;#ASMSTART
	buffer_load_dwordx2 v[86:87], v73, s[16:19], s84 offen
	;;#ASMEND
	;;#ASMSTART
	buffer_load_dwordx2 v[84:85], v73, s[20:23], s84 offen
	;;#ASMEND
	s_add_u32 s80, s79, 0x180
	buffer_load_dwordx4 v68, s[8:11], s81 offen lds
	s_mov_b32 m0, s41
	;;#ASMSTART
...
ds_read_b128 v[62:65], v102 offset:6144
	...
	buffer_load_dwordx4 v70, s[12:15], s82 offen lds
	s_mov_b32 m0, s52
	s_add_i32 s84, s71, 0xfffff400
	buffer_load_dwordx4 v69, s[12:15], s82 offen lds
	s_mov_b32 m0, s53
	;;#ASMSTART
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[220:223],  v[128:131], v[168:171], a[220:223],  v74, v77 op_sel:[1,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	;;#ASMEND
	;;#ASMSTART
	buffer_load_dwordx2 v[78:79], v73, s[20:23], s84 offen
	;;#ASMEND
	s_nop 0
	buffer_load_dwordx4 v71, s[12:15], s82 offen lds
	s_mov_b32 m0, s54
	s_nop 0
	buffer_load_dwordx4 v72, s[12:15], s82 offen lds
	s_mov_b32 m0, s43
	;;#ASMSTART
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[236:239], v[132:135], v[168:171], a[236:239], v75, v77 op_sel:[0,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	buffer_load_dwordx4 v70, s[12:15], s83 offen lds
	s_mov_b32 m0, s56
	s_nop 0
	buffer_load_dwordx4 v69, s[12:15], s83 offen lds
	s_mov_b32 m0, s57
	;;#ASMSTART
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[252:255], v[136:139], v[168:171], a[252:255], v75, v77 op_sel:[1,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	;;#ASMEND
	;;#ASMSTART
	buffer_load_dwordx2 v[92:93], v73, s[4:7], s84 offen
	;;#ASMEND
	;;#ASMSTART
	buffer_load_dwordx2 v[74:75], v73, s[0:3], s84 offen
	;;#ASMEND
	;;#ASMSTART
	buffer_load_dwordx2 v[90:91], v73, s[16:19], s84 offen
	;;#ASMEND
	s_add_i32 s84, s71, 0xfffff600
	buffer_load_dwordx4 v71, s[12:15], s83 offen lds
	s_mov_b32 m0, s58
	;;#ASMSTART
	buffer_load_dwordx2 v[76:77], v73, s[0:3], s84 offen
	;;#ASMEND
	;;#ASMSTART
	buffer_load_dwordx2 v[80:81], v73, s[20:23], s84 offen
	;;#ASMEND
	s_nop 0
	buffer_load_dwordx4 v72, s[12:15], s83 offen lds
...
ds_read_b128 v[30:33], v96 offset:6144
	...
	;;#ASMEND
	buffer_load_dwordx4 v66, s[8:11], s83 offen lds
	s_mov_b32 m0, s59
	s_nop 0
	buffer_load_dwordx4 v67, s[8:11], s83 offen lds
	s_mov_b32 m0, s60
	;;#ASMSTART
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[156:159],  v[132:135], v[62:65], a[156:159],  v82, v87 op_sel:[1,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	;;#ASMEND
	s_nop 0
	buffer_load_dwordx4 v94, s[8:11], s83 offen lds
	s_mov_b32 m0, s61
	s_nop 0
	buffer_load_dwordx4 v68, s[8:11], s83 offen lds
	s_mov_b32 m0, s40
	;;#ASMSTART
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[172:175], v[136:139], v[62:65], a[172:175], v83, v87 op_sel:[0,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	buffer_load_dwordx4 v66, s[8:11], s82 offen lds
	s_mov_b32 m0, s62
	s_nop 0
	buffer_load_dwordx4 v67, s[8:11], s82 offen lds
	s_mov_b32 m0, s63
	;;#ASMSTART
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[188:191], v[140:143], v[62:65], a[188:191], v83, v87 op_sel:[1,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	;;#ASMEND
	s_nop 0
	buffer_load_dwordx4 v94, s[8:11], s82 offen lds
	s_mov_b32 m0, s64
	s_nop 0
	buffer_load_dwordx4 v68, s[8:11], s82 offen lds
	s_mov_b32 m0, s42
	;;#ASMSTART
...
ds_read_b128 v[62:65], v100 offset:6144
	...
	buffer_load_dwordx4 v70, s[12:15], s81 offen lds
	s_mov_b32 m0, s65
	s_nop 0
	buffer_load_dwordx4 v69, s[12:15], s81 offen lds
	s_mov_b32 m0, s66
	;;#ASMSTART
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[220:223],  v[132:135], v[172:175], a[220:223],  v82, v85 op_sel:[1,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	;;#ASMEND
	s_nop 0
	buffer_load_dwordx4 v71, s[12:15], s81 offen lds
	s_mov_b32 m0, s67
	s_nop 0
	buffer_load_dwordx4 v72, s[12:15], s81 offen lds
	s_mov_b32 m0, s44
	;;#ASMSTART
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[236:239], v[136:139], v[172:175], a[236:239], v83, v85 op_sel:[0,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	buffer_load_dwordx4 v70, s[12:15], s80 offen lds
	s_mov_b32 m0, s68
	s_nop 0
	buffer_load_dwordx4 v69, s[12:15], s80 offen lds
	s_mov_b32 m0, s69
	;;#ASMSTART
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[252:255], v[140:143], v[172:175], a[252:255], v83, v85 op_sel:[1,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	;;#ASMEND
	;;#ASMSTART
	buffer_load_dwordx2 v[84:85], v73, s[16:19], s84 offen
	;;#ASMEND
	s_add_i32 s84, s71, 0xfffff800
	buffer_load_dwordx4 v71, s[12:15], s80 offen lds
	s_mov_b32 m0, s70
	;;#ASMSTART
	buffer_load_dwordx2 v[86:87], v73, s[16:19], s84 offen
	;;#ASMEND
	;;#ASMSTART
	buffer_load_dwordx2 v[82:83], v73, s[20:23], s84 offen
	;;#ASMEND
	s_nop 0
	buffer_load_dwordx4 v72, s[12:15], s80 offen lds
	s_mov_b32 m0, s33
	;;#ASMSTART
	s_waitcnt lgkmcnt(0)
	;;#ASMEND
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[188:191], v[140:143], v[62:65], a[188:191], v75, v91 op_sel:[1,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	;;#ASMEND
	;;#ASMSTART
	buffer_load_dwordx2 v[90:91], v73, s[4:7], s84 offen
	;;#ASMEND
	s_nop 0
	buffer_load_dwordx4 v94, s[8:11], s82 offen lds
	s_mov_b32 m0, s51
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[252:255], v[140:143], v[172:175], a[252:255], v75, v79 op_sel:[1,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	buffer_load_dwordx2 v[74:75], v73, s[0:3], s84 offen
	;;#ASMEND
	s_add_i32 s84, s71, 0xfffffa00
	buffer_load_dwordx4 v71, s[12:15], s80 offen lds
	s_mov_b32 m0, s58
	;;#ASMSTART
	buffer_load_dwordx2 v[78:79], v73, s[0:3], s84 offen
	;;#ASMEND
	s_nop 0
	buffer_load_dwordx4 v72, s[12:15], s80 offen lds
	s_mov_b32 m0, s38
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[252:255], v[140:143], v[172:175], a[252:255], v75, v83 op_sel:[1,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	;;#ASMEND
	s_add_i32 s79, s71, 0xfffffc00
	buffer_load_dwordx4 v71, s[12:15], s80 offen lds
	s_mov_b32 m0, s58
	;;#ASMSTART
	buffer_load_dwordx2 v[92:93], v73, s[4:7], s79 offen
	;;#ASMEND
	;;#ASMSTART
	buffer_load_dwordx2 v[74:75], v73, s[0:3], s79 offen
	;;#ASMEND
	;;#ASMSTART
	buffer_load_dwordx2 v[90:91], v73, s[16:19], s79 offen
	;;#ASMEND
	;;#ASMSTART
	buffer_load_dwordx2 v[76:77], v73, s[20:23], s79 offen
	;;#ASMEND
	s_nop 0
	buffer_load_dwordx4 v72, s[12:15], s80 offen lds
	s_mov_b32 m0, s38
...
ds_read_b128 v[62:65], v100 offset:6144
	...
	;;#ASMEND
	s_add_i32 s80, s71, 0xfffffe00
	buffer_load_dwordx4 v70, s[12:15], s77 offen lds
	s_mov_b32 m0, s65
	;;#ASMSTART
	buffer_load_dwordx2 v[88:89], v73, s[4:7], s80 offen
	;;#ASMEND
	;;#ASMSTART
	buffer_load_dwordx2 v[82:83], v73, s[0:3], s80 offen
	;;#ASMEND
	;;#ASMSTART
	buffer_load_dwordx2 v[86:87], v73, s[16:19], s80 offen
	;;#ASMEND
	;;#ASMSTART
	buffer_load_dwordx2 v[84:85], v73, s[20:23], s80 offen
	;;#ASMEND
	s_nop 0
	buffer_load_dwordx4 v69, s[12:15], s77 offen lds
	s_mov_b32 m0, s66
	;;#ASMSTART
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[220:223],  v[132:135], v[172:175], a[220:223],  v78, v81 op_sel:[1,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	;;#ASMEND
	s_nop 0
	buffer_load_dwordx4 v71, s[12:15], s77 offen lds
	s_mov_b32 m0, s67
	s_nop 0
	buffer_load_dwordx4 v72, s[12:15], s77 offen lds
	s_mov_b32 m0, s44
	;;#ASMSTART
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[236:239], v[136:139], v[172:175], a[236:239], v79, v81 op_sel:[0,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	;;#ASMEND
	s_nop 0
	buffer_load_dwordx4 v70, s[12:15], s76 offen lds
	s_mov_b32 m0, s68
	s_nop 0
	buffer_load_dwordx4 v69, s[12:15], s76 offen lds
	s_mov_b32 m0, s69
	;;#ASMSTART
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[252:255], v[140:143], v[172:175], a[252:255], v79, v81 op_sel:[1,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	;;#ASMEND
	s_nop 0
	buffer_load_dwordx4 v71, s[12:15], s76 offen lds
	s_mov_b32 m0, s70
	s_nop 0
	buffer_load_dwordx4 v72, s[12:15], s76 offen lds
...
ds_read_b128 v[30:33], v98 offset:6144
	...
	;;#ASMEND
	buffer_load_dwordx4 v66, s[8:11], s79 offen lds
	s_mov_b32 m0, s45
	s_sub_u32 s78, s77, s30
	buffer_load_dwordx4 v67, s[8:11], s79 offen lds
	s_mov_b32 m0, s46
	;;#ASMSTART
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[156:159],  v[128:131], v[62:65], a[156:159],  v74, v91 op_sel:[1,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	buffer_load_dwordx4 v94, s[8:11], s79 offen lds
	s_mov_b32 m0, s47
	s_sub_u32 s77, s77, s34
	buffer_load_dwordx4 v68, s[8:11], s79 offen lds
	s_mov_b32 m0, s39
	;;#ASMSTART
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[172:175], v[132:135], v[62:65], a[172:175], v75, v91 op_sel:[0,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	buffer_load_dwordx4 v66, s[8:11], s78 offen lds
	s_mov_b32 m0, s49
	s_sub_u32 s76, s76, s34
	buffer_load_dwordx4 v67, s[8:11], s78 offen lds
	s_mov_b32 m0, s50
	;;#ASMSTART
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[188:191], v[136:139], v[62:65], a[188:191], v75, v91 op_sel:[1,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	;;#ASMEND
	s_nop 0
	buffer_load_dwordx4 v94, s[8:11], s78 offen lds
	s_mov_b32 m0, s51
	s_nop 0
	buffer_load_dwordx4 v68, s[8:11], s78 offen lds
	s_mov_b32 m0, s41
	;;#ASMSTART
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[252:255], v[136:139], v[168:171], a[252:255], v75, v77 op_sel:[1,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	s_lshl_b32 s77, s76, 7
	s_add_u32 s76, s72, s77
	s_sub_u32 s79, s76, s30
	s_mov_b32 m0, s38
	;;#ASMSTART
	s_waitcnt lgkmcnt(0)
	;;#ASMEND
...
v_mfma_scale_f32_16x16x128_f8f6f4 a[236:239], v[132:135], v[168:171], a[236:239], v83, v85 op_sel:[0,1,0] op_sel_hi:[1,1,0] cbsz:4 blgp:4
	...
	s_mov_b32 m0, s68
	;;#ASMSTART
	buffer_load_dwordx2 v[80:81], v73, s[4:7], s80 offen
	;;#ASMEND
	;;#ASMSTART
	buffer_load_dwordx2 v[74:75], v73, s[0:3], s80 offen
	;;#ASMEND
	;;#ASMSTART
	buffer_load_dwordx2 v[78:79], v73, s[16:19], s80 offen
	;;#ASMEND
	;;#ASMSTART
	buffer_load_dwordx2 v[76:77], v73, s[20:23], s80 offen
	;;#ASMEND
	s_nop 0
	buffer_load_dwordx4 v69, s[12:15], s77 offen lds
	s_mov_b32 m0, s69
...
; COMPUTE_PGM_RSRC3_GFX90A:TG_SPLIT: 0
	...
	.text
	.type	__hip_cuid_683615d0155eab1b,@object ; @__hip_cuid_683615d0155eab1b
	.section	.bss,"aw",@nobits
	.globl	__hip_cuid_683615d0155eab1b
__hip_cuid_683615d0155eab1b:
	.byte	0                               ; 0x0
	.size	__hip_cuid_683615d0155eab1b, 1
	...
	.addrsig
	.addrsig_sym __hip_cuid_683615d0155eab1b
	.amdgpu_metadata
---
amdhsa.kernels:
  - .agpr_count:     256
