"""Benchmark: MXFP4 hybrid kernel (C++ structure + inline ASM MFMAs)."""
...
print(f"=== MXFP4 ColFirst Kernel: M={M}, N={N}, K={K} ===")
...
run = lambda: tk_mxfp4_colfirst.gemm_rcr(A, B, A_scale, B_scale, C)
...
outfile = os.environ.get("MXFP4_OUTPUT",
    f"mxfp4_colfirst_results_{M}x{N}x{K}{suffix}.json")
