#!/bin/bash
# R45 Reviewer Phase 1: 15th-cycle 4-GPU baseline 70B-KV V2-CRR (M=4096 N=1024 K=8192)
...
OUTDIR="$HERE/r45_reviewer_4gpu_runs"
mkdir -p "$OUTDIR"
...
echo "===== R45 Reviewer Phase 1 baseline cell=$CELL phys_gpu=$PHYS_GPU =====" | tee "$OUT"
date | tee -a "$OUT"
