...
#   This script's lack of G1 retry caused the R42 Reviewer P3.3
#   false-positive (GPU6 captured at sclk=1826MHz low-power state) that
#   triggered ~1 day of R43 Dev A escalation work to overturn.  Wrapped
#   bench in R36 NEW 3-gate retry loop:
