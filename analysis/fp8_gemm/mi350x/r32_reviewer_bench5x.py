"""R32 Reviewer: Single-process preheat + 5x bench for ONE kind (fp8 or mxfp8)
on ONE shape and ONE layout. Identical to r29_reviewer_bench5x.py EXCEPT:

R32 fix (R31 Reviewer paradigm correction):
...
Usage: ROCR_VISIBLE_DEVICES=N HIP_VISIBLE_DEVICES=0 PHYS_GPU=N \\
  python3 r32_reviewer_bench5x.py <kind> <layout> M N K
  kind   = fp8 | mxfp8
  layout = rcr | rrr | crr
