"""R28 Dev A: preheat once + 5x bench in same process for one already-built
variant. Mirrors r27a_bench5x.py with extra sclk telemetry.

Usage: HIP_VISIBLE_DEVICES=0 python3 r28a_bench5x.py <layout> M N K
