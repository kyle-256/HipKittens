#!/usr/bin/env python3
"""R55 Opt D-5B/2 — bench harness for the aiter `.co` dlopen shim on (32768, 28672, 2048).
...
HK R54 PASS_10/10 at 99.7% — D-3A-1 risk MEDIUM (closest to break-even).
...
WCF_GATE = 0.02
FINITE_GATE = 0.97
M, N, K = 32768, 28672, 2048
COMPETITOR_TFLOPS = 3353.4  # from R54_INTEGRATION_10RUN.json for (32768, 28672, 2048)
HK_PCT_COMP = 99.68  # R54 HK PASS_10/10 baseline
...
def main():
    ...
    ap.add_argument("--tag", default="R55_OPT_D5B_2")
    ...
    results = []
    log_lines = []
    log_lines.append(f"R55 Opt D-5B/2 bench — mode={args.mode}, gpu={gpu_list}, "
