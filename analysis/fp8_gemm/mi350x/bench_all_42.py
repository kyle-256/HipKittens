...
def main():
    ...
    variants = [
        ...
        # MEMCLAUSE variants (validate_memclause.py confirmed 3 LOSE→WIN flips)
        ...
        # Optimizer A WIN discoveries (2026-04-17)
        ...
        # Round 2: Optimizer A WIN discoveries (2026-04-17)
