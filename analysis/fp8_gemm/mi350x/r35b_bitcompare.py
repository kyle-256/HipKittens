"""R35 Dev B Stage A4: bit-compare HB shrink vs default V2-CRR on C[0,:8]."""
...
mod_def = load('tk_mxfp8_kv_default', os.environ['SO_A'])
mod_hbs = load('tk_mxfp8_kv_hbshrink', os.environ['SO_B'])
