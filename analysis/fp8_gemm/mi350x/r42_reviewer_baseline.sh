#!/bin/bash
# R42 Reviewer Phase 1: 4-GPU baseline 70B-KV V2-CRR (M=4096 N=1024 K=8192)
...
OUTDIR="$HERE/r42_reviewer_4gpu_runs"
mkdir -p "$OUTDIR"
...
echo "[r42_reviewer_baseline gpu=$PHYS_GPU md5=$H so=$SO_SRC stage=$STAGE_DIR]"
...
echo "===== R42 Reviewer Phase 1 baseline cell=$CELL phys_gpu=$PHYS_GPU =====" | tee "$OUT"
date | tee -a "$OUT"
