#!/usr/bin/env python3
"""R53 Opt D-3C — bench harness for aiter `.co` dlopen on (14336, 32768, 4096).

Cloned from bench_R52D2A.py. Uses 64x1024 aiter `.co` AS-IS (no shim rebuild).
...
COMPETITOR_TFLOPS = 4462.6  # from bench_all_42.py
...
def main():
    ...
    ap.add_argument("--tag", default="R53_OPT_D3C_1")
    args = ap.parse_args()
    ...
    results = []
    log_lines = []
    log_lines.append(f"R53 Opt D-3C bench — mode={args.mode}, gpu={gpu_list}, "
