...
def main() -> None:
    ...
    if (
        ...
        print("Conclusion: fused swapped step12 is numerically equivalent to the nonfused swap path; the earlier suspected br_d/a1_d layout mismatch is ruled out.")
