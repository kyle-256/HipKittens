#!/bin/bash
# R37 Reviewer Phase 1: 4-GPU triangulation for 70B KV V2-CRR (M=4096 N=1024 K=8192)
# Goal: 7th cross-cycle data point + verify R36 baseline of 775.15 TF holds.
...
OUTDIR="$HERE/r37_reviewer_4gpu_runs"
mkdir -p "$OUTDIR"
