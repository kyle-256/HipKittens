...
COMPETITOR_TFLOPS = 2995.0  # bench_all_42.py competitor for (16384, 4096, 2048)
...
def main():
    ...
    ap.add_argument("--tag", default="R57_OPT_L1")
    ...
    results = []
    log_lines = []
    log_lines.append(f"R57 Opt L-1 bench - mode={args.mode}, gpu={gpu_list}, "
