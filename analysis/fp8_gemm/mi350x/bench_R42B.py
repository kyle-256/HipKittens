...
ALL_CELLS = ["fence0_po104", "fence1_po104", "fence0_po0", "fence1_po0"]
...
def find_so(m, n, k, cell):
    ...
    mod = f"tk_mxfp4_gluon_cpp_n{n}_k{k}_{tag}_R42B_{cell}"
...
def bench_one_shape(m, n, k, comp, cell, gpu_id):
    ...
    if not so_path:
        return {"M": m, "N": n, "K": k, "tflops": None, "avg_ms": None,
                ...
                "best_variant": f"R42B_{cell}", "cell": cell}
