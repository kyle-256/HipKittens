#!/bin/bash
# R43 Reviewer Phase 1: 4-GPU baseline 70B-KV V2-CRR (M=4096 N=1024 K=8192)
...
OUTDIR="$HERE/r43_reviewer_4gpu_runs"
mkdir -p "$OUTDIR"
...
echo "===== R43 Reviewer Phase 1 baseline cell=$CELL phys_gpu=$PHYS_GPU =====" | tee "$OUT"
date | tee -a "$OUT"
