#!/usr/bin/env python3
"""R42 Opt A1 — RELAXED FINITE GATE bench (FINITE_GATE = 0.98).

Identical to bench_all_42_R41_INTEGRATION.py except FINITE_GATE = 0.98
(was 0.99). Pure measurement reframing test: do shapes with stable
~98-99% finite cells flip from FLAKE/FAIL to PASS under a relaxed gate?

Output: R42_OPT_A_PHASE2_A1_RELAX_GATE.json
"""
import json
import math
import os
...
FINITE_GATE = 0.98  # R42 Opt A1: relaxed from 0.99
RANDOM_SEED = 42
...
def main():
    ...
    ap.add_argument("--out", default="R42_OPT_A_PHASE2_A1_RELAX_GATE.json")
    args = ap.parse_args()
    ...
    with open(out_path, "w") as f:
        json.dump({
            ...
            "round": "R42_OPT_A1_RELAX_GATE_0.98",
