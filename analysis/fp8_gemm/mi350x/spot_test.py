...
VARIANTS = [
    ...
    ("lgk2_v4", "-DSTEP12_BR_LGKMCNT=2 -DSTEP3_BARRIER_VMCNT=4"),
    ("lgk2_v12", "-DSTEP12_BR_LGKMCNT=2 -DSTEP3_BARRIER_VMCNT=12"),
    ("lgk2_v16", "-DSTEP12_BR_LGKMCNT=2 -DSTEP3_BARRIER_VMCNT=16"),
    ("lgk4_v4", "-DSTEP12_BR_LGKMCNT=4 -DSTEP3_BARRIER_VMCNT=4"),
    ("lgk4_v12", "-DSTEP12_BR_LGKMCNT=4 -DSTEP3_BARRIER_VMCNT=12"),
    ("lgk4_v16", "-DSTEP12_BR_LGKMCNT=4 -DSTEP3_BARRIER_VMCNT=16"),
    ("ts_lgk2_v4", "-DTAIL_SPLIT=1 -DSTEP12_BR_LGKMCNT=2 -DSTEP3_BARRIER_VMCNT=4"),
    ("ts_lgk2_v16", "-DTAIL_SPLIT=1 -DSTEP12_BR_LGKMCNT=2 -DSTEP3_BARRIER_VMCNT=16"),
    ("ts_lgk4_v4", "-DTAIL_SPLIT=1 -DSTEP12_BR_LGKMCNT=4 -DSTEP3_BARRIER_VMCNT=4"),
    ("ts_lgk4_v12", "-DTAIL_SPLIT=1 -DSTEP12_BR_LGKMCNT=4 -DSTEP3_BARRIER_VMCNT=12"),
    ("ts_lgk4_v16", "-DTAIL_SPLIT=1 -DSTEP12_BR_LGKMCNT=4 -DSTEP3_BARRIER_VMCNT=16"),
    # LGKMCNT × NO_EMBED crosses
    ("lgk2_no_embed", "-DSTEP12_BR_LGKMCNT=2 -DSTEP3_EMBED_BARRIER=0"),
    ("ts_lgk2_no_embed", "-DTAIL_SPLIT=1 -DSTEP12_BR_LGKMCNT=2 -DSTEP3_EMBED_BARRIER=0"),
    ("ts_lgk2_no_embed_v12", "-DTAIL_SPLIT=1 -DSTEP12_BR_LGKMCNT=2 -DSTEP3_EMBED_BARRIER=0 -DSTEP3_BARRIER_VMCNT=12"),
    ...
    # FUSED_STEP34 (merged Steps 3+4 into single asm block)
    ("f34", "-DFUSED_STEP34=1"),
    ("f34_ts", "-DFUSED_STEP34=1 -DTAIL_SPLIT=1"),
    ("f34_lgk2", "-DFUSED_STEP34=1 -DSTEP12_BR_LGKMCNT=2"),
    ("f34_ts_lgk2", "-DFUSED_STEP34=1 -DTAIL_SPLIT=1 -DSTEP12_BR_LGKMCNT=2"),
    ("f34_v12", "-DFUSED_STEP34=1 -DSTEP3_BARRIER_VMCNT=12"),
    ("f34_v4", "-DFUSED_STEP34=1 -DSTEP3_BARRIER_VMCNT=4"),
    ("f34_ts_v12", "-DFUSED_STEP34=1 -DTAIL_SPLIT=1 -DSTEP3_BARRIER_VMCNT=12"),
    ("f34_gm2", "-DFUSED_STEP34=1 -DGROUP_SIZE_M=2"),
    ("f34_gm8", "-DFUSED_STEP34=1 -DGROUP_SIZE_M=8"),
    ("f34_ts_gm2_v12", "-DFUSED_STEP34=1 -DTAIL_SPLIT=1 -DGROUP_SIZE_M=2 -DSTEP3_BARRIER_VMCNT=12"),
    ("f34_ts_lgk2_v12", "-DFUSED_STEP34=1 -DTAIL_SPLIT=1 -DSTEP12_BR_LGKMCNT=2 -DSTEP3_BARRIER_VMCNT=12"),
    ("f34_u8", "-DFUSED_STEP34=1 -DUNROLL_K=8"),
    ("f34_u16", "-DFUSED_STEP34=1 -DUNROLL_K=16"),
