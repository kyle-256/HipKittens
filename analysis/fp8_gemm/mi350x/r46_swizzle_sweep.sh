#!/bin/bash
# R46: Sweep RRR XCD swizzle (Dev D) across all 7 compute-bound shapes.
...
for i in "${!SHAPES[@]}"; do
    ...
    run_rrr $M $N $K $L "" baseline
    run_rrr $M $N $K $L "-DMXFP8_RRR_BLOCK_SWIZZLE=1" swizzle
    ...
    echo "  RRR baseline: $BASE_TF TF | +SWIZZLE: $SWIZ_TF TF"
done

echo ""
echo "========== SWIZZLE SUMMARY =========="
