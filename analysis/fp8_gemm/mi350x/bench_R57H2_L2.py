...
WCF_GATE = 0.02
FINITE_GATE = 0.97
M, N, K = 16384, 4096, 3072
COMPETITOR_TFLOPS = 3492.3  # bench_all_42.py competitor for (16384, 4096, 3072)
...
def main():
    ...
    ap.add_argument("--tag", default="R57_OPT_L2")
    ...
    results = []
    log_lines = []
    log_lines.append(f"R57 Opt L-2 bench - mode={args.mode}, gpu={gpu_list}, "
